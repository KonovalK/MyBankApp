...
const SelectedSavingBankMinusPage = () => {
    ...
    const savingCardRequest = () => {
        if(data.card && data.summa){
            setLoading(true);
            axios.put(`/api/saving-bank-withdraw/${savingBankNum}`, data,userAuthenticationConfig()).then(response => {
    ...
    return (
        <>
            ...
            <EditSavingBankForm setData={setData} cards={cards} action="withdraw"/>
        </>
    );
};

export default SelectedSavingBankMinusPage;
